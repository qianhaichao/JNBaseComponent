...
@implementation UIView (XMBorder)
...
- (void)xm_addTopBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth {
    [self xm_addTopBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}


- (void)xm_addLeftBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth {
    [self xm_addLeftBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}


- (void)xm_addBottomBorderWithColor:(UIColor *)color width:(CGFloat) borderWidth {
    [self xm_addBottomBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}


- (void)xm_addRightBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth {
    [self xm_addRightBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}
...
- (void)xm_addTopBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth excludePoint:(CGFloat)point edgeType:(XMExcludePoint)edge {
    ...
    if (edge & XMExcludeStartPoint) {
        startPoint += point;
    }

    if (edge & XMExcludeEndPoint) {
        endPoint += point;
    }
