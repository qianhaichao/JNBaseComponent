...
@property (nonatomic, copy) UIImageSizeRequestCompleted jk_sizeRequestCompletion;
@end

@implementation NSURL (RemoteSize)

- (void)setJk_sizeRequestCompletion: (UIImageSizeRequestCompleted) block {
    objc_setAssociatedObject(self, &kSizeRequestCompletionKey, block, OBJC_ASSOCIATION_COPY);
}

- (UIImageSizeRequestCompleted)jk_sizeRequestCompletion {
